...
export const PRESETS = {
  "web-app": ["web", "api", "data", "identity"],
  "mobile-app": ["mobile", "api", "data", "identity"],
  "web-mobile-app": ["web", "mobile", "api", "data", "identity"],
  "multi-tenant-web-app": ["web", "api", "data", "identity", "tenancy"],
  "api-service": ["api", "data", "identity"],
